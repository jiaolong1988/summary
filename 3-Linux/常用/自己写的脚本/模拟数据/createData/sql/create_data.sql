...
BEGIN
  ...
  WHILE current_num < total_num LOOP
	...
	VALUES ('0900ba'||current_num,'pkuuid'||current_num,'3ad52c5fa5b54974a1db9db7d008b506','15','#datatype#','uni'||current_num,' ',' ',' ',' ','00',' ',' ','2021-09-23T17:05:38Z','1.0','Y','20210812170545','test'||task_id,' ','0','0');
